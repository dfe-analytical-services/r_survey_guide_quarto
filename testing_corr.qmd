...
However, there isn't currently an R function that can calculate Spearman's with weighted data. The function below is based on un-weighted data. This isn't a huge issue since it's a rank-based measure.
...
Kendall's is similar to Spearman's, but it better suited to the following:
